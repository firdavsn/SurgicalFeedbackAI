...
This project aims to automate the analysis of feedback in surgical training, specifically focusing on detecting, categorizing, and assessing feedback provided during urology surgery training sessions using the da Vinci surgical system. The project leverages advanced natural language processing (NLP) techniques and machine learning models to analyze dialogue between trainers and trainees.
...
- **run_train.py**: Prepares transcriptions for training by extracting video files, creating dataframes, and using OpenAI's Whisper model for transcription.
...
code
 ...
 directory to analyze dialogue metrics, test similarity thresholds, and more. For example, to run the 
...
To prepare transcriptions for training, run the 
...
This README provides a comprehensive overview of the project, including its structure, key components, setup instructions, 
>>>>>>> 47f34c6128c06ce4fff88a115dad84ab26f4e643
